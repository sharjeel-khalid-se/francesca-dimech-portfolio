  ...
  const videos = [
    {
      ...
      image: Placeholder1,
      description:
        "A comprehensive showcase of character acting for screen and television.",
    ...
    },
    {
      ...
      image: Placeholder2,
      description:
        "Live theatrical performance incorporating acting and musical instrumentation.",
    ...
    },
    {
      ...
      image: Placeholder3,
      description:
        "A theatrical production focusing on poignant social themes.",
      youtubeUrl: "https://www.youtube.com/embed/oIqht17bDYE",
    },
    {
      id: 4,
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:items-start justify-between">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-8">
                Francesca Dimech is a multi-instrumentalist actor-musician and
                voiceover artist. With extensive experience across television,
                theatre, and presenting live events, she brings a versatile
                range of emotional depth and technical precision to every
                project.
                <br />
                <br />
                ...
                Actores, cerddor ac artist troslais yw Francesca Dimech sy wedi
                ymddangos ar deledu, theatr ac wedi cyflwyno sawl digwyddiad
                byw.
              </p>
            ...
            <div className="hidden lg:block w-80 bg-gray-50 rounded-2xl p-8 border border-gray-100 shrink-0">
              ...
              <div className="space-y-4 text-sm mb-8">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-gray-600 mb-2">
                    <strong className="text-gray-900">Spotlight PIN:</strong>{" "}
                    9492-8979-9003
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <a
                  href="https://www.imdb.com/name/nm10528515/"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-between px-4 py-2 bg-white border border-gray-200 rounded-md text-sm font-semibold text-gray-700 hover:border-violet-600 hover:text-violet-600 transition-colors"
                >
                  IMDb Profile <ExternalLink size={14} />
                </a>
                <a
                  href="https://www.voquent.com/voice-actor/37901/"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-between px-4 py-2 bg-white border border-gray-200 rounded-md text-sm font-semibold text-gray-700 hover:border-violet-600 hover:text-violet-600 transition-colors"
                >
                ...
                <a
                  href="https://sites.gravyforthebrain.com/website/francescadimech"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-between px-4 py-2 bg-white border border-gray-200 rounded-md text-sm font-semibold text-gray-700 hover:border-violet-600 hover:text-violet-600 transition-colors"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-10 gap-6">
            <div>
              ...
              <p className="text-gray-500 text-sm md:text-base">
                Selected works from screen acting, theatre, and comedy.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {filteredVideos.map((video) => (
              <div
                key={video.id}
                className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col"
              >
                <div
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            ...
            <p className="text-gray-500 text-sm md:text-lg max-w-2xl mx-auto">
              Specializing in commercial narration, bilingual English/Welsh
              recordings, and character voices from a professional home studio
              setup.
            </p>
          </div>
          ...
          <div className="bg-violet-600 rounded-2xl md:rounded-3xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-between text-center md:text-left text-white shadow-lg">
            <div className="mb-6 md:mb-0">
              <h3 className="text-lg md:text-xl font-bold mb-2">
                Need a custom demo for your project?
              </h3>
              <p className="text-violet-200 text-sm md:text-base">
                Available for fast turnaround auditions globally via Source
                Connect.
              </p>
            </div>
            <Link
